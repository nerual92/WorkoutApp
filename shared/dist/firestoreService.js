 ...
 */
export async function saveWorkoutSession(uid, session, programName) {
 ...
 */
export async function saveUserProgram(uid, program) {
 ...
 */
export async function clearUserProgram(uid) {
    const { error } = await supabase
        .from('user_programs')
        .upsert({
        user_id: uid,
 ...
 */
export function subscribeToProgramChanges(uid, callback) {
